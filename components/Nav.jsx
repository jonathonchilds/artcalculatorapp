...
const Nav = () => {
  ...
  const pageButtons =
    "rounded-full shadow-lg border border-black w-60 h-20 py-1.5 px-5 hover:bg-red-700 hover:text-white transition-all text-center text-lg font-semibold flex items-center justify-center ";
